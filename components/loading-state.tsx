  ...
  return (
    <>
      ...
      <div style={{ padding: pagePad, paddingTop: "20px" } as React.CSSProperties}>
        ...
        {/* Summary card */}
        <div style={{ ...shell, ...ghost(0), padding: "20px 24px", marginBottom: 16 }}>
          <div style={{ ...bone(120, 11), marginBottom: 14 }} />
          <div style={{ ...boneDim("95%", 9), marginBottom: 6 }} />
          <div style={{ ...boneDim("88%", 9), marginBottom: 6 }} />
          <div style={{ ...boneDim("78%", 9), marginBottom: 6 }} />
          <div style={boneDim("55%", 9)} />
        </div>

        {/* Smart Money Health / Watch List */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
          <div style={{ ...shell, ...ghost(0.1) }}>
            <GhostCardHdr />
            <div style={{ padding: "16px 20px" }}>
              {[0, 1, 2].map((j) => (
                <div key={j} style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: divider, alignItems: "center" }}>
                  <div style={boneDim(90, 9)} />
          ...
          <div style={{ ...shell, ...ghost(0.2) }}>
            <GhostCardHdr />
            <div style={{ padding: "16px 20px", display: "flex", flexWrap: "wrap" as const, gap: 8 }}>
              {Array.from({ length: 6 }).map((_, j) => (
                <div key={j} style={{ height: 28, width: 44 + (j % 3) * 10, borderRadius: 7, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.07)" }} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div style={{ ...shell, marginBottom: 16 }}>
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} style={{ ...ghost(i * 0.14), padding: "12px 20px", borderBottom: divider, display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div style={boneDim(32, 8)} />
              <div style={{ ...boneDim(28, 9), marginLeft: "auto" }} />
            </div>
          ))}
        </div>
        ...
        <div style={shell}>
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} style={{ ...ghost(i * 0.14), padding: "12px 20px", borderBottom: divider, display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div style={pill(52, 20)} />
              <div style={{ ...boneDim(60, 9), marginLeft: "auto" }} />
            </div>
          ))}
        </div>
