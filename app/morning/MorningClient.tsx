...
const S = {
  page:  { padding: space.pagePaddingX, maxWidth: "900px", margin: "0 auto" },
  card:  { ...C.base },
...
export function MorningClient({ initialData }: { initialData: unknown }) {
  ...
  if (!data) return <div style={{ padding: "28px", ...S.muted }}>Loading morning scan...</div>;
