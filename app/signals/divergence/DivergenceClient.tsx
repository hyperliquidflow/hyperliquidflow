            ...
            <div style={S.card}>
              ...
              {selectedIdea.trade_plan ? (
                <div style={{ padding: "20px" }}>
                  ...
                  <div style={{ marginTop: "16px", padding: "10px 12px", background: "rgba(201,36,53,0.06)", borderRadius: "5px", border: "1px solid rgba(201,36,53,0.15)" }}>
                    <p style={{ fontSize: "11px", color: "rgba(201,36,53,0.8)", lineHeight: 1.6 }}>
