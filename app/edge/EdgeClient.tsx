"use client";
// app/edge/EdgeClient.tsx — client wrapper; receives server-fetched initialData so no skeleton on load.
...
function RecipeGrid({ stats }: { stats: RecipeStats[] }) {
...
export function EdgeClient({ initialStats }: { initialStats: RecipeStats[] }) {
