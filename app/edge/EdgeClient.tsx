...
export function EdgeClient({ initialData }: { initialData: RecipeStats[] | null }) {
              ...
              <div key={id} className="card-hover glow-btn" style={C.base}>
                ...
                {isNew ? (
                  ...
                  <>
                    ...
                    <div style={S.heroRow}>
                      <div style={S.heroCel}>
                        <div style={{ ...S.heroVal, color: acc24h != null ? accuracyColor(acc24h) : color.textFaint }}>
                          {fmtAcc(acc24h)}
                          {isLow && <span style={S.lowSample}>~</span>}
                        </div>
                        <div style={S.heroLbl}>Accuracy 24h</div>
                      </div>
                      <div style={S.heroCel}>
                        <div style={{ ...S.heroVal, color: move24h == null ? color.textFaint : move24h >= 0 ? color.green : color.red }}>
                          {fmt(move24h)}
                        </div>
                        <div style={S.heroLbl}>Avg Move 24h</div>
                      </div>
                    </div>
