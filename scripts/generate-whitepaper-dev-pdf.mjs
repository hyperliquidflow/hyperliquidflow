// scripts/generate-whitepaper-dev-pdf.mjs
// Run: node scripts/generate-whitepaper-dev-pdf.mjs
...
const htmlPath = path.resolve(__dirname, '../docs/hyperliquidflow-whitepaper-dev.html');
const pdfPath  = path.resolve(__dirname, '../docs/hyperliquidflow-whitepaper-dev.pdf');
